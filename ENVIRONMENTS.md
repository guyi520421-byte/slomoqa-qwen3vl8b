...
- `/data/miniconda3/envs/egoVqa/bin/python`：Whisper ASR、Qwen2.5-VL OCR 与 Base Qwen3-VL 推理。核心依赖包括 PyTorch、Transformers、bitsandbytes、qwen-vl-utils、OpenCV、Pillow、PyAV。
